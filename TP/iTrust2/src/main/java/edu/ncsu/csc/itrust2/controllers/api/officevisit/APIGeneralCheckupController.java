...
public class APIGeneralCheckupController extends APIController {
    ...
    public ResponseEntity updateGeneralCheckup ( @PathVariable final Long id,
        ...
        try {
            ...
            // for (final Prescription pdb : dbVisit.getPrescriptions() ) {
            // Prescription found = null;
            // for (final Prescription p : visit.getPrescriptions()) {
            // if (p.getPharmacyName().equals( pdb.getPharmacyName() )) {
            // found = p;
            // break;
            // }
            // }
            // if (found == null) {
            // final List<Prescription> prescriptionsAtOldPharmacy =
            // Pharmacy.getByName( pdb.getPharmacyName() ).prescriptions;
            // for (int i = 0; i < prescriptionsAtOldPharmacy.size(); i++) {
            // if (prescriptionsAtOldPharmacy.get( i ).)
            // }
            // }
            // }
