...
public enum TransactionType {
     ...
     * Pharmacy created
     */
    CREATE_PHARMACY ( 504, "New pharmacy created", false ),
    /**
     * Pharmacy viewed by user
     */
    VIEW_PHARMACY ( 505, "Pharmacy viewed", false ),
    /**
     * Pharmacy modified by user
     */
    EDIT_PHARMACY ( 506, "Pharmacy edited", false ),
    /**
     * Pharmacy deleted
     */
    DELETE_PHARMACY ( 507, "Pharmacy deleted", false ),
    /**
     * Pharmacist assigned to a pharmacy.
     */
    ASSIGN_PHARMACIST ( 508, "Pharmacist assigned", false ),
    /**
     * Pharmacist assignment changed.
     */
    MOVE_PHARMACIST ( 509, "Pharmacist assignment moved to different pharmacy.", false ),
    ...
    /**
     * An email is sent to a patient upon prescription being filled or
     * unavailable
     */
    CREATE_FILL_PRESCRIPTION_EMAIL ( 1405, "Prescription email notification sent", true ),
    /**
    ...
    /**
     * Pharmacist views prescriptions sent to pharmacy.
     */
    PHARMACIST_PRESCRIPTION_VIEW ( 3101, "Prescriptions sent to pharmacy viewed", false ),

    /**
     * Prescription filled by pharmacist.
     */
    PRESCRIPTION_FILLED ( 3102, "Prescription filled", true ),
    ...
    /**
     * Patient changes prescription type for the first time.
     */
    DECLARE_DEFAULT_PRESCRIPTION ( 3201, "Patient has declated a default prescription type.", true ),

    /**
     * Patient changes default pharmacy for the first time.
     */
    DECLARE_DEFAULT_PHARMACY ( 3202, "Patient has declated a default pharmacy.", true ),

    /**
     * Patient changes prescription type.
     */
    UPDATE_DEFAULT_PRESCRIPTION ( 3203, "Patient has updated their default prescription type.", true ),

    /**
     * Patient changes default pharmacy.
     */
    UPDATE_DEFAULT_PHARMACY ( 3204, "Patient has updated their default pharmacy.", true );
