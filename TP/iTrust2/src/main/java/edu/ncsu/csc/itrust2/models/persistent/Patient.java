...
public class Patient extends DomainObject<Patient> implements Serializable {
    ...
    public Patient ( final PatientForm form ) throws ParseException {
        ...
        if ( form.getDefaultPharmacy() != null ) {
            setDefaultPharmacy( form.getDefaultPharmacy() );
        }
        else {
            setDefaultPharmacy( null );
        }

        if ( form.getDefaultPrescriptionType() == null ) {
            // setDefaultPrescriptionType( PrescriptionType.GENERIC );
            this.defaultPrescriptionType = null;
        }
        else if ( form.getDefaultPrescriptionType().equals( "Generic" ) ) {
            setDefaultPrescriptionType( PrescriptionType.GENERIC );
        }
        else {
            setDefaultPrescriptionType( PrescriptionType.BRAND_NAME );
        }
    ...
    /**
     * The default prescription type that the patient would like all
     * prescriptions to be.
     */
    @Enumerated ( EnumType.STRING )
    private PrescriptionType defaultPrescriptionType;
    ...
    /**
     * Changes the preferred prescription type of the user.
     *
     * @param type
     *            The new prescription type they would like to have.
     */
    public void setDefaultPrescriptionType ( final PrescriptionType type ) {
        this.defaultPrescriptionType = type;
    }

    /**
     * Gets the patient's default prescription setting.
     *
     * @return Returns the patient's preferred prescription type.
     */
    public PrescriptionType getDefaultPrescriptionType () {
        return defaultPrescriptionType;
    }

    /**
     * Changes the patient's default pharmacy location.
     *
     * @param pharmacy
     *            The new default pharmacy for the patient.
     */
    ...
    /**
     * Gets the patient's default pharmacy.
     *
     * @return Returns the patient's default pharmacy.
     */
