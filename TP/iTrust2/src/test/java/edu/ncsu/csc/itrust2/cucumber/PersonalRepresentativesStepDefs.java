...
public class PersonalRepresentativesStepDefs extends CucumberTest {
    ...
    public void createUsers () {
        ...
        setTextField( By.name( "username" ), "Warioo" );
        setTextField( By.name( "password" ), "123456" );
        ...
        waitForAngular();
        wario.setSelf( User.getByName( "Warioo" ) );
        wario.setFirstName( "wario" );
        wario.setLastName( "Smith" );
        wario.setDateOfBirth( LocalDate.now().minusYears( 13 ) ); // Thirteen
                                                                  // years old
        wario.save();
        ...
        waluigi.setDateOfBirth( LocalDate.now().minusYears( 13 ) ); // Thirteen
                                                                    // years old
        waluigi.save();
        waitForAngular();
    ...
    public void findWario () {
        ...
        driver.findElement( By.id( "Warioo-declare" ) ).click();
        waitForAngular();
    ...
    public void removePersonalRepresentative () {
        ...
        assertTrue( driver.getPageSource().contains( "Warioo" ) );

        driver.findElement( By.id( "undeclareButton" ) ).click();
        waitForAngular();

        driver.findElement( By.id( "Warioo-representing" ) ).click();
    ...
    public void seePatient () {
        ...
        waitForAngular();
        driver.findElement( By.id( "Warioo-representingName" ) ).isEnabled();
    }
