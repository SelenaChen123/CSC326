...
Scenario Outline: Valid recipe
	...
	When I submit valid values for name: <recipeName>; cost: <price>; and ingredients: <amtCoffee> coffee, <amtMilk> milk, <amtSugar> sugar, <amtWater> water
	Then the recipe is successfully added
	
Examples:
	| existingRecipes | recipeName | price | amtCoffee | amtMilk | amtSugar | amtWater |
	| 0               | Coffee     | 50    | 3         | 1       | 1        | 0        |
	| 1               | Mocha      | 60    | 3         | 2       | 2        | 3        |
	| 2               | Latte      | 60    | 3         | 3       | 2        | 0        |
...
Scenario Outline: Invalid Price
	Given the CoffeeMaker already has 1 Recipes
	When I attempt to submit the following recipe values - name: <recipeName>; cost: <price>; and ingredients: <amtCoffee> coffee, <amtMilk> milk, <amtSugar> sugar, <amtWater> water
	Then the error for an invalid recipe price occurs
	And the recipe is not added

Examples:
	| recipeName   | price | amtCoffee | amtMilk | amtSugar | amtWater |
...
Examples:
	| recipeName   | price | amtCoffee | amtMilk | amtSugar | amtWater | ingredient |
	...
	| Coffee       | 10    | 3         | 1       | 1        | -1       | water      |
	| Coffee       | 10    | 3         | 1       | 1        | Why?     | water      |
	| Coffee       | 10    | 3         | 1       | 1        | %        | water      |
	| Coffee       | 10    | 3         | 1       | 1        | 6.5      | water      |
	| Coffee       | 10    | 3         | 1       | 1        | null     | water      |
