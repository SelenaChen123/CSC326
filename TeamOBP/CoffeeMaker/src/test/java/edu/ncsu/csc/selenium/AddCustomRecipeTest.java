...
public class AddCustomRecipeTest extends SeleniumTest {
    ...
    protected void setUp () throws Exception {
        ...
        if ( Ingredient.getByType( "Coughy" ) == null ) {
            driver.get( baseUrl );
            ...
            driver.findElement( By.xpath( "//input[@ng-model=\"ingredient.ingredient\"]" ) ).sendKeys( "Coughy" );
            driver.findElement( By.xpath( "//input[@ng-model=\"ingredient.amount\"]" ) ).clear();
            driver.findElement( By.xpath( "//input[@ng-model=\"ingredient.amount\"]" ) ).sendKeys( "10" );
    ...
    private void navigateToAddCustomRecipe () {
        ...
        driver.findElement( By.name( "name" ) ).sendKeys( "Coughy" );
